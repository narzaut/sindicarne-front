...
export function SelectInput({ options, placeholder, errors, register, value, required }) {
	return (
		<div className='flex py-3 flex-col w-52 '>
					<select className='text-shadow text-center text-gray-100 border-4 border-transparent focus-border-green bg-blue-900  rounded  pl-2' {...register(value, { required: required })}>
